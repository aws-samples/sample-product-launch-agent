...
role_name = f"ProductLaunchAssistantBedrockAgentCoreRole-{REGION}"
policy_name = f"ProductLaunchAssistantBedrockAgentCorePolicy-{REGION}"
    ...
    policy_document = {
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Resource": [
                    f"arn:aws:ssm:{region}:{account_id}:parameter/app/productlaunch/agentcore/memory_id"
                ],
            },
        ],
    }
